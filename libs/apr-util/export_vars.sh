...
APRUTIL_EXPORT_INCLUDES="-I/usr/src/AiSwitch/libs/apr-util/xml/expat/lib"
APRUTIL_EXPORT_LIBS="/usr/src/AiSwitch/libs/apr-util/xml/expat/lib/libexpat.la"
APRUTIL_LDFLAGS="-L/usr/src/AiSwitch/libs/apr-util/xml/expat/lib"
