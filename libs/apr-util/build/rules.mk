...
#
apr_builddir=/usr/src/AiSwitch/libs/apr
apr_builders=/usr/src/AiSwitch/libs/apr/build

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.2.8
...
EXTRA_LDFLAGS=
EXTRA_LIBS=-luuid -lrt -ldl -lcrypt  -lpthread
EXTRA_INCLUDES=
...
LINK         = $(LIBTOOL) $(LTFLAGS) --mode=link $(LT_LDFLAGS) $(COMPILE) -version-info 2:8:2 $(ALL_LDFLAGS) -o $@
